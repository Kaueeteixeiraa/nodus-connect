...
const source = join(root, "native", "service", "main.cpp");
const outputDir = join(root, "native", "bin");
const output = join(outputDir, "nodus-service.exe");
...
if (!existsSync(compiler)) throw new Error("Toolchain nativo do Windows nao encontrado.");
